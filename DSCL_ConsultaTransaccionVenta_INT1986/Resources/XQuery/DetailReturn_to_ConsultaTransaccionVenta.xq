        ...
        <ns1:ConsutaTransVentaOpResponse>
            <ns0:respConsultaTransaccionVenta>
                ...
                <ns0:DetailReturn>
                    ...
                    <ns0:CNTransactiondate1>{ concat(substring($detailReturn1/RespuestaEspecifica/sFechaVenta,7,2),
	'-',
	substring($detailReturn1/RespuestaEspecifica/sFechaVenta,5,2),
	'-',
	substring($detailReturn1/RespuestaEspecifica/sFechaVenta,1,4)) }</ns0:CNTransactiondate1>
